...
<html>
    <head>
        <title>Subharambha Restaurant POS</title>
                    ...
                    <div class="main_top fix">
                        ...
                        <div class="waiter_customer">
                            <div class="single_button_middle_holder" style="padding-left:.4%;width:32.9%">
                                ...
                                <select style="width:92%;margin-left:2px;" id="waiter" id="select_waiter" class="select2">
            ...
            <div class="modal-content" id="modal_finalize_order_details">
                ...
                <div class="fo_2 fix">
                    ...
                    <div class="half fix floatleft textright">
                        <select name="finalize_order_payment_method" id="finalize_order_payment_method">
